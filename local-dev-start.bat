...
echo.
start "Ebook Reader - Backend Dev Server" cmd /c "cd /d D:\Projects\ebook-reader\backend && npm install && npm run dev"
...
echo       Using: Vite HMR
echo.
start "Ebook Reader - Frontend Dev Server" cmd /c "cd /d D:\Projects\ebook-reader\frontend && npm install && npm run dev"
